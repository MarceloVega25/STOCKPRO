                            ...
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_apellido" class="form-control"
                                                    value="{{ ($vehiculo->nombre_apellido) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="dni" class="form-control"
                                                    value="{{($vehiculo->dni) }}" required maxlength="8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="fecha_nacimiento" class="form-control"
                                                    value="{{ ($vehiculo->fecha_nacimiento) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="genero" class="form-control" required>
                                                    ...
                                                    <option value="masculino" {{ trim(strtolower($vehiculo->genero)) == 'masculino' ? 'selected' : '' }}>Masculino</option>
                                                    <option value="femenino" {{ trim(strtolower($vehiculo->genero)) == 'femenino' ? 'selected' : '' }}>Femenino</option>
                                                    <option value="otro" {{ trim(strtolower($vehiculo->genero)) == 'otro' ? 'selected' : '' }}>Otro</option>
                                                </select>
                                                @error('genero')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="telefono" class="form-control"
                                                    value="{{ ($vehiculo->telefono) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="institucion" class="form-control"
                                                    value="{{ ($vehiculo->institucion) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="tipo" class="form-control" required>
                                                    <option value="">Seleccione...</option>
                                                    <option value="titular" {{ trim(strtolower($vehiculo->tipo)) == 'titular' ? 'selected' : '' }}>Titular</option>
                                                    <option value="suplente" {{ trim(strtolower($vehiculo->tipo)) == 'suplente' ? 'selected' : '' }}>Suplente</option>
                                                </select>
                                                @error('tipo')
                                                    <small style="color: red;">*Este campo es requerido</small>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($vehiculo->cv)
                                                <p><a href="{{ asset('storage/' . $vehiculo->cv) }}" target="_blank">Ver CV actual</a></p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <center>
                                            @php
                                                if (!empty($vehiculo->fotografia) && file_exists(public_path('storage/' . $vehiculo->fotografia))) {
                                                    $fotoPath = asset('storage/' . $vehiculo->fotografia);
                                                } else {
                                                    $avatarPath = 'images/' . strtolower($vehiculo->genero) . '.jpg';
