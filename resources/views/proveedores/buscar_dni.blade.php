        ...
        <div class="col-md-11">
            <div class="card card-outline card-warning">
                ...
                <div class="card-body" style="display: block;">
                    <form method="POST" action="{{ route('proveedores.buscarDni') }}">
                        @csrf
...
@if(session('mensaje') === 'existe')
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('proveedores.edit', session('proveedor_id')) }}";
        });
    </script>
@endif
...
@if(session('mensaje') === 'nuevo')
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('proveedores.create', ['dni' => session('dni')]) }}";
        });
    </script>
@endif
<script>
