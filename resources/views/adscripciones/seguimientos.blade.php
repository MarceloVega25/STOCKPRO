...
@section('content')
    <div class="content" style="margin-left: 20px">
        <h1>Seguimientos de la Adscripción</h1>
        ...
        <div class="row">
            <div class="col-md-11">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        @if ($adscripcion->seguimientos->isEmpty())
                            <div class="alert alert-info">
                                No hay seguimientos registrados para esta Adscripción.
                            </div>
                        @else
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($adscripcion->seguimientos as $s)
                                                <tr>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                @role('admin|carga')
                                    <a href="{{ route('adscripciones.edit', $adscripcion->id) }}" class="btn btn-warning">Editar Adscripcion</a>
                                @endrole
                            </div>
                        </div>
