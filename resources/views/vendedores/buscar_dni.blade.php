        ...
        <div class="col-md-11">
            <div class="card card-outline card-warning">
                ...
                <div class="card-body" style="display: block;">
                    <form method="POST" action="{{ route('vendedores.buscarDni') }}">
                        @csrf
...
@if(session('mensaje') === 'existe')
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('vendedores.edit', session('vendedor_id')) }}";
        });
    </script>
@endif
...
@if(session('mensaje') === 'nuevo')
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('vendedores.create', ['dni' => session('dni')]) }}";
        });
    </script>
@endif
